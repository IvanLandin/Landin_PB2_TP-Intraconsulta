...
public class TestUniversidad {
	...
	public void queSePuedaAsignarUnProfesorAUnaComision() {
		...
		CicloLectivo cicloLectivo = new CicloLectivo(universidad.getIdCicloLectivo(), LocalDate.of(2023, 8, 14),
				LocalDate.of(2023, 12, 2), LocalDate.of(2023, 7, 31), LocalDate.of(2023, 8, 10));
		Materia materia = new Materia(universidad.getIdMateria(), 2625, "BD1");
		Comision comision = new Comision(universidad.getIdComision(), materia, 3300, cicloLectivo, Turnos.MANIANA);
		...
		assertEquals(1, universidad.obtenerListaDeProfesoresDeUnaComision(comision).size());
	}
